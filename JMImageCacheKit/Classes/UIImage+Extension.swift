...
extension UIImage {
    public static func gifImageWithData(_ data: Data) -> UIImage? {
        guard let source = CGImageSourceCreateWithData(data as CFData, nil) else {
            "image doesn't exist".log(where: "UIImage/gifImageWithData")
            return nil
        }
    ...
    private static func delayForImageAtIndex(_ index: Int, source: CGImageSource!) -> Double {
        ...
        let delay = (delayObject as! Double) < minimumDelay ? minimumDelay : delayObject as! Double
